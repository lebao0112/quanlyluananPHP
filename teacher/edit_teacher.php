        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                    ...
                    $sql = "UPDATE GiangVien SET HoTen='$hoTen', MaGiangVien='$maGiangVien', Email='$email', SoDienThoai='$soDienThoai', BoMon='$boMon' WHERE GiangVienID=$id";
                ...
                <form method="POST" action="edit_teacher.php">
                    <input type="hidden" name="id" value="<?php echo $row['GiangVienID']; ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="MaGiangVien" class="form-control" value="<?php echo $row['MaGiangVien']; ?>" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="BoMon" class="form-control" value="<?php echo $row['BoMon']; ?>" required>
                    </div>
